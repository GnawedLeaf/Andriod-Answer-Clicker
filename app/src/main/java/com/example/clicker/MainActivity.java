...
public class MainActivity extends AppCompatActivity {
    ...
    public int qNo = 1, start =0,master = 1, pressed = 0;
    //private String ipAddress = "//http://192.168.10.109:9999/clicker/select?choice=";
    //private String ipAddress2="http://192.168.10.109:9999";
    private String ipMaster;
    private String choice,ipInput;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null){
            ipInput = extras.getString("key");

            //http://192.168.10.109:9999
    ...
    public void btnAHandler(View view){
        ...
        pressed = 1;
        choice = "a";
        //http://192.168.10.109:9999/clicker/select?choice=
        webView.loadUrl(ipMaster+ "/clicker/select?choice=" + choice +"&questionNo=" + qNo);
        ...
        if (start == 0 && master == 1){
            ...
            new CountDownTimer(2000,1000){
                ...
                public void onFinish(){
                    ...
                    new HttpTask().execute(ipMaster +"/clicker/getenable");
    ...
    public void randomButtonPresser(){
        int random = randomNumber(1,3);
        if (random == 1) btnA.performClick();
        else if (random == 2 )btnB.performClick();
        else if (random == 3) btnC.performClick();
        else if (random == 4) btnD.performClick();
    }
